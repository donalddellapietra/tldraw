...
import { TLDefaultFontSizeStyle } from '@tldraw/editor';
...
// @public (undocumented)
export const CustomStylePanel: NamedExoticComponent<TLUiCustomStylePanelProps>;

// @public (undocumented)
export function CustomStylePanelContent({ styles }: TLUiCustomStylePanelContentProps): JSX_2.Element;
...
// @public (undocumented)
export function StylePanelColorPicker(): JSX_2.Element;
...
export function useCustomFormattingManager(): {
    manager: CustomFormattingManager;
    state: {
...
// @public (undocumented)
export function VerticalFormattingBar({ isVisible }: VerticalFormattingBarProps): JSX_2.Element | null;
